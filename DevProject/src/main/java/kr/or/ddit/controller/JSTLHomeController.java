...
public class JSTLHomeController {
	 ...
	 * 		<fmt:parseDate>			|		문자열으 Date 객체로 변환한다.
	 * 
	 ...
	 * 		varStatus	|	String		|	루프상태를 저장할 EL 변수 이름
