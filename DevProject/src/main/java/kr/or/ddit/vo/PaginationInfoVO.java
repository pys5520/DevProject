...
public class PaginationInfoVO<T> {
	private int totalRecord; 	//총 게시글 수 - 121개
	private int totalPage; 		//총 페이지 수 - 13페이지
	private int currentPage;	//현재 페이지
	private int screenSize = 10;//페이지 당 게시글 수 -10개씩
	private int blockSize = 5;	//페이지 블록 수 - 페이지 번호를 몇개씩 나타낼거니? << 1 2 3 4 5 >>
	private int startRow;		//시작 row  
	private int endRow;			//끝 row 
	private int startPage;		//시작 페이지  
	private int endPage;		//끝 페이지 
	private List<T> dataList;	//결과를 넣을 데이터 리스트 - 1페이지에 해당하는 게시글 목록을 담을 공간
	private String searchType;	//검색 타입(제목, 내용, 작성자, 작성일 등등)
	private String searchWord;	//검색 단어(키워드)
	
	public PaginationInfoVO() {}
	
	// PaginationInfoVO 객체를 만들 때, 한 페이지 당 게시글 수와 페이지 블록 수를
